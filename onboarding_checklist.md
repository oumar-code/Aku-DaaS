...
Use this checklist to get started with DaaS (Device as a Service).
...
## 6. Build & Run
- [ ] Build Docker image: `docker build -t daas:latest .`
- [ ] Run locally: `npm run dev` or `npm start`
- [ ] Or run with Docker: `docker run -p 8080:8080 daas:latest`
